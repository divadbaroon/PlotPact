      ...
      <section className='py-16 px-4 sm:px-6 lg:px-8 bg-primary/5'>
        <div className='container mx-auto max-w-6xl'>
          <div className='text-center mb-12'>
            ...
            <p className='text-xl text-muted-foreground max-w-3xl mx-auto'>
              PlotPact offers a range of features to enhance the collaborative
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-8'>
            <div className='flex gap-4'>
              ...
              <div>
                ...
                <p className='text-muted-foreground'>
                  Both human and AI can enforce narrative constraints, creating
            ...
            <div className='flex gap-4'>
              ...
              <div>
                ...
                <p className='text-muted-foreground'>
                  Choose from various author styles like Mark Twain, Stephen
            ...
            <div className='flex gap-4'>
              ...
              <div>
                ...
                <p className='text-muted-foreground'>
                  Set the theme for your story - professional writing, thriller,
                  comedy, and more.
                </p>
              </div>
            </div>
            ...
            <div className='flex gap-4'>
              ...
              <div>
                ...
                <p className='text-muted-foreground'>
                  An intelligent agent checks both user and AI inputs to ensure
                  all content follows established constraints.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className='py-16 px-4 sm:px-6 lg:px-8 bg-primary text-primary-foreground'>
        <div className='container mx-auto max-w-6xl text-center'>
          ...
          <p className='text-xl max-w-3xl mx-auto mb-8 text-primary-foreground/90'>
            Join PlotPact today and experience a new way of collaborative
            storytelling that challenges your creativity and enhances your
            writing skills.
          </p>
      ...
      <section className='py-16 px-4 sm:px-6 lg:px-8 bg-background'>
        <div className='container mx-auto max-w-6xl'>
          <div className='text-center mb-12'>
            ...
            {/* <p className='text-xl text-muted-foreground max-w-3xl mx-auto'>
              The brilliant minds behind PlotPact
            </p> */}
          </div>

          <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
            {['David Barron', 'Muhammad Danish', 'Shuvam Shiwakoti'].map(
              (name, index) => (
                <div
                  key={index}
